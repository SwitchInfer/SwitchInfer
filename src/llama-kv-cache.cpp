...
//    for (int i = 0; i < n_layer; i++) {
//        ggml_tensor * k = cache.k_l[i];
//        ggml_tensor * v = cache.v_l[i];
//
////         realloc kv cache data on numa nodes
//        const int numa_node = i % numa_num;
//        k->data = numa_alloc_onnode(k->nb[3], numa_node);
//        v->data = numa_alloc_onnode(v->nb[3], numa_node);
//    }
