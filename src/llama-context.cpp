...
//    auto &kv_cache = ctx->kv_self;
//    auto &k_cache = kv_cache.k_l;
//    auto &v_cache = kv_cache.v_l;
//    const int kv_num = k_cache.size();
//    for (int i = 0 ; i < kv_num; i++) {
//        numa_free(k_cache[i]->data, k_cache[i]->nb[3]);
//        numa_free(v_cache[i]->data, v_cache[i]->nb[3]);
//    }
